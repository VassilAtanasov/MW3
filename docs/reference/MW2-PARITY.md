...
| G-6 | **Forges**: a third building type giving a global attack/defence buff to its owner, 125–150% defence and 150–200% attack, capping at 4 | Two building types only. **Assigned to phase 6** (`docs/forges/`, wf `3900095949a7`), discovered 05-08-2026: the type and its structural seams (FR-1, `69b8d6032657`), a contested neutral forge and neutral tower on an eight-base map (FR-2, `65f7360af81d`), the count-keyed global buff (FR-3, `8554c22a4421`), the forge morale rows (FR-4, `eb92138da99f`), the menu entry and drawing (FR-5, `06341f0fa15b`), and an AI that contests forges (FR-6, `b78d24560dd7`). **Closed for the rules layer 06-08-2026**: FR-1 (#82), FR-4 (#83), FR-2 (#86) and FR-3 (#87) are merged, so a forge exists, is contested on the shipped map, moves morale, and buys its owner the published global buff. Drawing is still owed by FR-5 (#89) and a forge-aware AI by FR-6 — the same treatment G-1 received when phase 5 FR-4 closed its rules half | Phase 3 §6 forbade a third type *that phase* — sequencing, not design. Feeds the combat formula (G-7), which FR-3 closes. Forge **levels** are not owed by any phase: MW2 gives forges exactly one tier (`MW2-RULES.md` §2, §2.4) |
