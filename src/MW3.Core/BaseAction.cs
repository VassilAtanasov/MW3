...
/// <see cref="BaseActionKind.Upgrade"/> and set to the opposite of the base's current type for
/// <see cref="BaseActionKind.Convert"/> - the action carries its own target so the widget never
/// picks one itself (D-25, FR-5).
/// </summary>
